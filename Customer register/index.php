...
{
$searchresult = $_POST['home_search'];
$searchbar->search($searchresultar);
header('location: wrokspaces.php' );
				...
				<div class="row">
					<div class="col-lg-10 offset-lg-1">
						<div class="domain_search_form_container">
							<form action="POST" id="domain_search_form" class="domain_search_form d-flex flex-md-row flex-column align-items-center justify-content-start">
